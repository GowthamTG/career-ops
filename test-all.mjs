...
const scripts = [
  ...
  { name: 'basic-validate-pipeline.mjs --self-test', expectExit: 0 },
  { name: 'resolve-leads.mjs --self-test', expectExit: 0 },
  { name: 'scan-shortlist.mjs --self-test', expectExit: 0 },
  { name: 'social-ingest.mjs --self-test', expectExit: 0 },
